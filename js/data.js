...
/* PROJELER — yeni proje eklemek için bir nesne ekle.
   status: "tamamlandi" | "devam" | "fikir"
   links:  { demo: "...", repo: "...", site: "..." } (boş bırakılabilir)  */
const PROJECTS = [
  {
    title: "Bu Web Sitesi",
    desc: "Kendi kişisel sitem — blog, projeler, mini oyunlar ve galeri. Saf HTML/CSS/JS ile yazıldı.",
  ...
  {
    title: "Tavla Zarı",
    desc: "İki oyunculu, renk seçilebilen, geçmiş ve kazanma oranı gösteren zar atıcı.",
    tags: ["JavaScript", "Oyun", "UI"],
    status: "tamamlandi",
    year: 2024,
    links: { demo: "oyun-zar.html" },
  },
  {
    title: "Tetris",
    desc: "Canvas üzerinde klasik Tetris; skor, seviye ve sıradaki parça gösterimiyle.",
    tags: ["Canvas", "JavaScript", "Oyun"],
    status: "tamamlandi",
    year: 2024,
    links: { demo: "oyun-tetris.html" },
  },
];
